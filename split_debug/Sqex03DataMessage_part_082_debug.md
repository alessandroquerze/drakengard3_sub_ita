...
`Che hai detto?{#Name="Zero"}`
What was that?{#Name="Zero"}

`Mia signora, queste rovine sono estremamente preziose e—{#Name="Decadus"}`
My lady, these ruins are extremely valuable and—{#Name="Decadus"}

`CHE HAI DETTO!?{#Name="Zero"}`
WHAT WAS THAT!?{#Name="Zero"}

`N-Niente, mia signora... Nnngh...{#Name="Decadus"}`
N-Nothing, my lady... Nnngh...{#Name="Decadus"}

`Ugh, di nuovo questi tizi? Mi sto stancando di questa storia.{#Name="Dito"}`
...
`La magia muove queste bestie.{LF}Ma da dove proviene?{#Name="Octa"}`
Magic drives these beasts.{LF}Yet where does it come from?{#Name="Octa"}

`Non di nuovo queste piattaforme di merda...{#Name="Zero"}`
Not this platform shit again...{#Name="Zero"}

`Questo richiederà riflessi rapidi{LF}e pazienza estrema.{#Name="Decadus"}`
This will require both quick reflexes{LF}and extreme patience.{#Name="Decadus"}

`Preferirei spezzarle in due e seppellirle{LF}insieme a tutto questo dannato posto.{#Name="Zero"}`
I'd rather just break 'em in half and bury 'em{LF}along with this whole damn place.{#Name="Zero"}

`Mia signora, vi prego! Le rovine!{#Name="Decadus"}`
My lady, please! The ruins!{#Name="Decadus"}

`Il comportamento rozzo di Lady Zero è piuttosto preoccupante, no?{#Name="Octa"}`
Lady Zero's crude behavior is quite troubling, no?{#Name="Octa"}

`Beh... Preferisco pensarlo come...spontaneo.{#Name="Decadus"}`
Well... I prefer to think of it as...spontaneous.{#Name="Decadus"}

`No, credo che "rozzo" sia la parola migliore qui.{#Name="Dito"}`
No, I think "crude" is the better word here.{#Name="Dito"}

`Voglio dire, diamine, prima ha mangiato carne cruda{LF}dal pavimento!{#Name="Dito"}`
...
`Voglio dire, hanno praticamente venduto{LF}le loro anime per ottenere potere.{#Name="Dito"}`
I mean, they pretty much sold{LF}their souls to gain power.{#Name="Dito"}

`Sì? Possono vendersi il culo{LF}per quanto mi riguarda- ora sono miei!{#Name="Zero"}`
Yeah? They can sell their assholes{LF}for all I care—they're mine, now!{#Name="Zero"}

`Oh, andiamo! Non abbiamo ANCORA finito con questo roba?{#Name="Zero"}`
Oh, come on! We're STILL not done with this?{#Name="Zero"}

`Mia signora, vi prego di restare calma.{LF}La rabbia non risolverà nulla qui.{#Name="Decadus"}`
My lady, please remain calm.{LF}Anger will solve nothing here.{#Name="Decadus"}

`Caaaaaaaaazzo!{#Name="Zero"}`
Fuuuuuuuuuck!{#Name="Zero"}

`Oh ho ho! Un altro degli amati{LF}rompicapi di salti di Lady Zero, vedo.{#Name="Octa"}`
Oh ho ho! Another of Lady Zero's{LF}beloved jumping puzzles, I see.{#Name="Octa"}

`Ma seriamente, cosa alimenta tutto questo?{#Name="Dito"}`
But seriously, what's powering all this?{#Name="Dito"}

`Mi chiedo...{#Name="Octa"}`
I wonder...{#Name="Octa"}

`Fammi indovinare- magia, giusto?{#Name="Zero"}`
...
`Oh, fidati, non è solo il braccio.{LF}Z può far ricrescere praticamente qualsiasi cosa.{#Name="Dito"}`
...
`Sì. Come la tua libido.{#Name="Dito"}`
Yeah. Like your sex drive.{#Name="Dito"}

`Cent affermò che il drago di Zero sarebbe stato la sua rovina.{#Name="Accord"}`
Cent claimed Zero's dragon would be her downfall.{#Name="Accord"}

`Qual era il significato dietro questa profezia inquietante?{#Name="Accord"}`
What was the meaning behind this ominous prophecy?{#Name="Accord"}

`In cerca di informazioni, Zero viaggiò fino alle rovine sotto la Terra delle Sabbie…{#Name="Accord"}`
In search of information, Zero traveled to the ruins beneath the Land of Sands…{#Name="Accord"}

`Zero è qui! Presto, bruciate i documenti!{#Name="Soldier A"}`
Zero's here! Hurry, burn the papers!{#Name="Soldier A"}

`Non lasciate che raggiunga Lady Two!{#Name="Soldier A"}`
