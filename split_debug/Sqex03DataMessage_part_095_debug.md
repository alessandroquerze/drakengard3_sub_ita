...
`Dirigiti alla Cattedrale.{#Name="説明文"}`
...
`Zero! Demone abominevole!{#Name="Soldier B"}`
Zero! You abominable demon!{#Name="Soldier B"}

`まさに、忌まわしき災い！{#Name="兵士Ｂ"}`
まさに、忌まわしき災い！{#Name="兵士Ｂ"}

`Coraggio, gente!{#Name="Soldier C"}`
Chin up, people!{#Name="Soldier C"}

`Coraggio? Stiamo per MORIRE!{#Name="Soldier D"}`
Chin up? We're gonna DIE!{#Name="Soldier D"}

`Allora affronta la morte con cuore saldo!{#Name="Soldier C"}`
Then face your death with a stout heart!{#Name="Soldier C"}

`State indietro. Sarò io il vostro scudo!{#Name="Soldier F"}`
Stay back. I'll be your shield!{#Name="Soldier F"}

`S-Sei sicuro?{#Name="Soldier G"}`
A-Are you sure?{#Name="Soldier G"}

`I soldati veterani devono essere fari di speranza per i giovani. Ora dietro di me!{#Name="Soldier F"}`
...
`I nostri numeri vanno benissimo! Ora combatteteee!{#Name="Soldier A"}`
...
`Continuate a muovervi!{#Name="Soldier E"}`
Keep moving!{#Name="Soldier E"}

`Supporto posteriore!{#Name="Soldier B"}`
Rear support!{#Name="Soldier B"}

`Ricevuto! Richiedo rinforzi ora!{#Name="Soldier D"}`
Got it! Requesting backup now!{#Name="Soldier D"}

`D-Dannazione! Non arretrate! Non arre...trate...{#Name="Soldier A"}`
D-Damn! Don't fall back! Don't fall...back...{#Name="Soldier A"}

`Capitano!{#Name="Soldier E"}`
Captain!{#Name="Soldier E"}

`Continuate a muovervi!{#Name="Soldier F"}`
Keep moving!{#Name="Soldier F"}

`Signore! Non abbiamo più dove andare!{#Name="Soldier G"}`
Sir! We have nowhere left to go!{#Name="Soldier G"}

`Li stiamo almeno ferendo!?{#Name="Soldier C"}`
...
`Forza, muovetevi! Dannazione, stupide gambe, MUOVETEVI!{#Name="Soldier B"}`
Come on, move! Goddammit, you stupid legs, MOVE!{#Name="Soldier B"}

`Che rottura! Non possiamo semplicemente uccidere tutti{LF}e levarci dalle palle una buona volta?{#Name="Dito"}`
This is such a drag! Can we just kill everyone{LF}and get the hell outta here already?{#Name="Dito"}

`Sono sicuro che lo si capisca dal mio volto,{LF}ma sono quello che si potrebbe definire...delicato.{#Name="Cent"}`
I'm sure you can tell by my face,{LF}but I'm what you might call...delicate.{#Name="Cent"}

`Beh, è stata una lunga battaglia.{LF}State iniziando a rallentare?{#Name="Octa"}`
Well, it has been a long battle.{LF}Are you starting to slow down?{#Name="Octa"}

`Cielo, no! Non scambiare la mia{LF}disinvoltura rilassata per pigrizia, mmm?{#Name="Cent"}`
Heavens no! Don't mistake this laid-back{LF}ease of mine for laziness, mmm?{#Name="Cent"}

` {#Name="セント"}`
 {#Name="セント"}

`Dobbiamo tenere Lady Zero al sicuro!{#Name="Decadus"}`
We must keep Lady Zero safe!{#Name="Decadus"}

`Sono abbastanza sicuro che "Lady Zero" sappia{LF}badare al proprio culo benissimo.{#Name="Dito"}`
I'm pretty sure "Lady Zero" can{LF}watch her own ass just fine.{#Name="Dito"}

`Diavolo, semmai dovrebbe essere lei a proteggere NOI!{#Name="Dito"}`
Hell, if anything, she should be protecting US!{#Name="Dito"}

`どっちかっつーと、{LF}こっちがゼロに守ってもらいたいくらいだ{#Name="ディト"}`
どっちかっつーと、{LF}こっちがゼロに守ってもらいたいくらいだ{#Name="ディト"}

`Non dire certe cose!{LF}Dobbiamo dare tutto per la nostra Intoner!{#Name="Decadus"}`
Don't say such things!{LF}We must give all for our Intoner!{#Name="Decadus"}

`Percepisco il respiro putrido di{LF}soldati tremanti di paura.{#Name="Decadus"}`
...
`Zero, stai bene? La forza del{LF}fiore sta diventando più forte!{#Name="Mikhail"}`
Zero, are you okay? The flower's{LF}force is getting stronger!{#Name="Mikhail"}

`Continua...ad andare...{#Name="Zero"}`
...
`Eh, già che sono qui, tanto vale dare una mano{LF}a Z.{#Name="Dito"}`
Eh, I figure I might as well help Z{LF}out as long as I'm here.{#Name="Dito"}

`Vedi, Dito? Il potere della vera{LF}amicizia conquista tutto!{#Name="Decadus"}`
You see, Dito? The power of genuine{LF}friendship conquers all!{#Name="Decadus"}

`Sì, sì. Non farti diventare le mutande {LF}un groviglio per questo. Mi stai inquietando.{#Name="Dito"}`
Yeah, yeah. Don't get your panties in a{LF}bunch about it. You're creepin' me out.{#Name="Dito"}

`Cielo. Che cosa mai dovremmo fare ora?{#Name="Cent"}`
Goodness. Whatever are we to do now?{#Name="Cent"}

`Io seguirò Lady Zero fino ai confini della terra.{#Name="Octa"}`
I shall follow Lady Zero to the ends of the earth.{#Name="Octa"}

`E se muori?{#Name="Cent"}`
