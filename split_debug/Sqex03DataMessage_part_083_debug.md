...
`Ugh! Questo caldo mi sta uccidendo.{#Name="Zero"}`
...
`La luce del sole sembra essersi improvvisamente intensificata.{#Name="Decadus"}`
...
`Eccoci di nuovo con la magia.{LF}Davvero fottutamente comodo!{#Name="Zero"}`
...
`Non siamo tutti invincibili come te, ricordi?{#Name="Dito"}`
We aren't all invincible like you, remember?{#Name="Dito"}

`Beh, mi fa comunque incazzare.{#Name="Zero"}`
...
`Smettila di tentare di fare il profondo, Octa.{LF}Non ti si addice.{#Name="Zero"}`
Quit trying to be deep, Octa.{LF}It doesn't suit you.{#Name="Zero"}

`*Anf, anf...*{#Name="Decadus"}`
*Huff, huff...*{#Name="Decadus"}

`In difficoltà, Decadus?{#Name="Dito"}`
Having trouble, Decadus?{#Name="Dito"}

`Nnngh... In effetti, sì... Ma...{LF}affronterò qualunque prova per la mia signora.{#Name="Decadus"}`
...
`Oh, meraviglioso.{#Name="Zero"}`
Oh, that's just wonderful.{#Name="Zero"}

`Credo che sto per impazzire.{#Name="Zero"}`
I think I'm about to go insane.{#Name="Zero"}

`Fantastico. Ora abbiamo un gigantesco, uomo-cavallo fiammeggiante.{#Name="Zero"}`
...
`Si sta indebolendo.{#Name="Decadus"}`
